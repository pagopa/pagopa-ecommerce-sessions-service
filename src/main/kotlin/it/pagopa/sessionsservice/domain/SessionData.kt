...
data class SessionData(@Id var rptId: RptId, var email: String, var paymentToken: String, var token: String?){
    init {
        ...
        // val paymentTokenRegex = "".toRegex()

        require(email matches emailRegex) { "Email must be RFC 5322 compliant." }
        // require(paymentToken matches paymentTokenRegex)  { "Name is blank" }
    }
}
